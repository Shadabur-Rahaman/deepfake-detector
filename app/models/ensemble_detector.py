...
class UltraEnsembleDetector:
    ...
    def __init__(self):
        ...
        # Updated weights to include MesoNet
        self.weights = {
            'efficientnet': 0.25,           # Your base model
            'mesonet': 0.25,                # MesoNet specialized detection
            'free_ai_ensemble': 0.25,       # Free AI ensemble
            'enhanced_detector': 0.15,      # Enhanced detector
            'vision_transformer': 0.10      # ViT if available
        }
        self.models_loaded = False
    ...
    async def initialize_models(self):
        ...
        try:
            logger.info("🔄 Initializing Ultra-Ensemble with MesoNet...")
            ...
            try:
                ...
                logger.warning("⚠️ MesoNet not available")
            ...
            try:
                ...
                logger.info("✅ Free AI ensemble loaded")
            except ImportError:
                logger.warning("⚠️ Free AI ensemble not available")
            ...
            try:
                ...
                logger.info("✅ Enhanced detector loaded")
            except ImportError:
                logger.warning("⚠️ Enhanced detector not available")
            ...
            try:
                ...
                logger.warning("⚠️ Vision Transformer not available")
            
            self.models_loaded = True
            logger.info(f"✅ Ultra-ensemble initialized with {len(self.models)} models")
            
        except Exception as e:
            logger.error(f"❌ Ultra-ensemble initialization failed: {e}")
            raise
    ...
    async def ultra_detect(self, faces, video_path: str = None):
        ...
        try:
            ...
            logger.info(f"📊 Models used: {len(results)}, Final score: {final_score:.3f}")
