...
def get_model_availability():
    ...
    try:
        from advanced_models.yolov8_face import AdvancedYOLOv8FaceDetector
        ...
        try:
            ...
            import importlib
            yolov8_module = importlib.import_module('advanced_models.yolov8_face')
    ...
    try:
        from advanced_models.mesonet_detector import MesoNet
        ...
        try:
            # Try alternative import using importlib
            import importlib
            mesonet_module = importlib.import_module('advanced_models.mesonet_detector')
    ...
    try:
        from advanced_models.ensemble_detector import AdvancedEnsembleDetector
        # Test instantiation to ensure it's functional
        ...
        try:
            # Try alternative import using importlib
            import importlib
            ensemble_module = importlib.import_module('advanced_models.ensemble_detector')
