...
try:
    from utils.advanced_model_loader import setup_advanced_models_paths, get_model_availability
    paths_added = setup_advanced_models_paths()
    print(f"✅ Advanced models paths configured: {len(paths_added)} paths added")
except ImportError as e:
    ...
    try:
        ...
        if validation_score < 0.8:
            try:
                ...
                gen_result = await gen_ai_analyzer.analyze_with_all_models(faces)
...
async def get_models_status():
    ...
    try:
        from utils.model_importer import MODEL_AVAILABILITY
        return {
